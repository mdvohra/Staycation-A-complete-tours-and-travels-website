...
<meta charset="UTF-8">
	...
	<link href="css1/hover-min.css" rel="stylesheet"/>
	<link href="css1/main.css" rel="stylesheet"/>
   	<link href="https://fonts.googleapis.com/css?family=Oswald:200,300,400|Raleway:100,300,400,500|Roboto:100,400,500,700" rel="stylesheet">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
	
	<script src="js1/jquery-3.2.1.min.js" type="text/javascript"></script>
...
<!-- Custom Theme files -->
<script src="js1/jquery-1.12.0.min.js"></script>
...
<div class="header">
<?php include('common/headerTransparentLoggedOut.php');?>
</div>
<!--- banner ---->
<div class="banner-3">
	<div class="container">

  ...
  <body >
          ...
          <h1>Admin Panel</h1>
             ...
             <div class="options">
			  ...
			  <h3><a href="add_package.php">ADD PACKAGE</a></h3>
			  <h3><a href="viewpbk.php">PACKAGE BOOKINGS</a></h3>
			  ...
			  <h3><a href="manage_page.php">UPDATE ABOUT US</a></h3>
              <h3><a href="adminLogout.php">LOGOUT</a></h3>
    </center>
    </div>
    <center>
    <button class="btn btn-secondary"> <a href="\travel1\index.php"><h5>Click here to go to user panel</h5></a></button>
    </center>   
  </body>
</html>
